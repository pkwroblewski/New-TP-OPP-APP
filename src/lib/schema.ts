...
export const DetailedLoanSchema = z.object({
  ...
  margin_bps: z.number().optional().nullable(), // margin over benchmark in basis points
  covenant_indicators: z.boolean().optional().nullable(), // true if covenants mentioned
...
export const AssetsControlledSchema = z.object({
...
export const FunctionalAnalysisSchema = z.object({
...
export const TPDocumentationSchema = z.object({
...
export const IPTransactionSchema = z.object({
...
export const IPTransactionsSchema = z.object({
...
export const ServiceArrangementSchema = z.object({
...
export const ServiceArrangementsSchema = z.object({
...
export const ArmsLengthAssessmentSchema = z.object({
  ...
  benchmark_reference: z.string().optional().nullable(), // e.g., "EURIBOR + 350bps"
...
export const CompanyProfileTPRelevantInfoSchema = z.object({
