...
export const DEMO_EXTRACTION_RESULT: ExtractionResult = {
  ...
  notes_extraction: {
    ...
    detailed_loans_granted: [
      {
        counterparty_name: "German OpCo GmbH",
        jurisdiction: "DE",
        instrument_type: "interest_bearing" as const,
        original_principal: 22000000,
        currency: "EUR",
        execution_date: "2020-06-15",
        maturity_date: "2026-12-31",
        interest_rate: 4.5,
        rate_adjustments: null,
        current_principal: 22000000,
        capitalised_interest: 2500000,
        accrued_interest: 500000,
        current_year_total: 25000000,
        previous_year_total: 23000000,
        note_reference: "Note 4",
        account_caption: "1139",
        is_from_shareholder: false,
      },
      {
        counterparty_name: "French Holdings SAS",
        jurisdiction: "FR",
        instrument_type: "interest_bearing" as const,
        original_principal: 15000000,
        currency: "EUR",
        execution_date: "2021-01-10",
        maturity_date: "2025-06-30",
        interest_rate: 4.25,
        rate_adjustments: "minus remuneration 0.10%",
        current_principal: 15000000,
        capitalised_interest: 1800000,
        accrued_interest: 200000,
        current_year_total: 17000000,
        previous_year_total: 15000000,
        note_reference: "Note 4",
        account_caption: "1139",
        is_from_shareholder: false,
      },
    ...
    detailed_loans_received: [
      {
        counterparty_name: "Parent Corp B.V.",
        jurisdiction: "NL",
        instrument_type: "interest_bearing" as const,
        original_principal: 55000000,
        currency: "EUR",
        execution_date: "2019-03-01",
        maturity_date: "2028-12-31",
        interest_rate: 2.0,
        rate_adjustments: null,
        current_principal: 55000000,
        capitalised_interest: 4500000,
        accrued_interest: 500000,
        current_year_total: 60000000,
        previous_year_total: 54000000,
        note_reference: "Note 7",
        account_caption: "1379-1383",
        is_from_shareholder: true,
      },
    ],
    shareholder_loans: [
      {
    ...
    account_captions: [
      {
        code: "1139",
        description: "Loans to affiliated undertakings",
        current_year: 42000000,
        previous_year: 38000000,
        is_ic: true,
      },
      {
        code: "1379-1383",
        description: "Amounts owed to affiliated undertakings",
        current_year: 60000000,
        previous_year: 54000000,
        is_ic: true,
      },
      {
        code: "1397-1401",
        description: "Other creditors (shareholder loans)",
        current_year: 60000000,
        previous_year: 54000000,
        is_ic: true,
      },
  ...
  entity_governance: {
    ...
    administrator: "Luxembourg Corporate Services S.A.",
    shareholder_name: "Parent Corp B.V.",
    shareholder_jurisdiction: "Netherlands",
  },
  tp_analysis: {
    ic_financing: {
